<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin.Master" validateRequest="false" CodeBehind="EMailNotAttending.aspx.vb" Inherits="CCFRW19.EMailNotAttending" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        <div class="pPage"><div class="pPage"><div class="pHeader">Email Members Not Attending</div><br />
        <asp:Table ID="Table1" runat="server">
            <asp:TableRow>
               <asp:TableCell>
                    <asp:Label ID="Label1" runat="server" Text="EventDate:" width="100px" cssclass="pStrongTextRight" />
               </asp:TableCell><asp:TableCell>
                    <asp:Textbox ID="EventDate" width="600px" runat="server" readonly="true"/>
                </asp:TableCell> </asp:TableRow>
             <asp:TableRow> 
               <asp:TableCell>
                    <asp:Label ID="Label2" runat="server" Text="Subject:" width="100px" cssclass="pStrongTextRight" />
               </asp:TableCell><asp:TableCell>
                    <asp:TextBox ID="Subject" width="600px" runat="server" />
                </asp:TableCell> </asp:TableRow>
 <asp:TableRow>
                ...
                <asp:TableCell  width="600px">
                    ...
                    <asp:Button ID="btnUpload" Text="Upload" runat="server" Height="23px" OnClick ="UploadMultipleFiles" accept ="image/gif, image/jpeg" />
                     <asp:Button ID="Clear" Text="Clear Attachments" runat="server" Height="23px" OnClick ="ClearAttachments" accept ="image/gif, image/jpeg" />
                </asp:TableCell>
     </asp:TableRow>
      <asp:TableRow>
                <asp:TableCell Width="100px" >
                ...
                <asp:TableCell  Width="400px"> <asp:TextBox ID="MessageText" runat="server" TextMode="MultiLine"></asp:TextBox>
