...
Public Class Global_asax
    ...
    'This Module is used To handle application Errors.  A custom error page is displayed And an email Is sent To the webmaster containing the stact trace for the error.  
    'In addition a message is saved in the error_log table in the database.
